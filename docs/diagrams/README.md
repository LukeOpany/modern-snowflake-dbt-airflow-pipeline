...
- [PNG preview](../images/pipeline-visuals.png)

## Pipeline Architecture

- [Editable Excalidraw](pipeline-architecture.excalidraw)
- [Scalable SVG](pipeline-architecture.svg)
- [PNG preview](../images/pipeline-architecture.png)
